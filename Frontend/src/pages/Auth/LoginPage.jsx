...
const LoginPage = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-linear-to-br from-slate-50 via-white to bg-slate-50">
      ...
      <div className="relative w-full max-w-md px-6">
        ...
        <p className="text-center text-xs text-slate-400 mt-6">
              By continuing, you agree to our Terms & Privacy Plicy
        </p>
      </div>
    </div>
  );
