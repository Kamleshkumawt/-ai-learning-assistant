...
const AIAction = () => {
  ...
  <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 overflow-hidden">
    ...
    <div className="p-6 space-y-6">
        ...
        <form onSubmit={handleExplainConcept}>
          ...
          <div className="flex items-center gap-3">
            <input
              ...
              className="flex-1 h-11 px-4 border-2 border-slate-200 rounded-xl bg-slate-50/50 text-slate-900 placeholder-slate-400 text-sm font-medium transition-all duration-200 focus:outline-none focus:border-emerald-500 focus:bg-white focus:shadow-lg focus:shadow-purple-500/25"
      ...
      title={modalTitle}
      >
        <div className="max-h-[60vh] overflow-y-auto prose prose-sm prose-slate">
