    ...
    >
      <div className="space-y-4">
        ...
        <div className="flex items-start gap-4">
          <div className="shrink-0 w-12 h-12 bg-linear-to-br from-emerald-100 to-teal-100 flex items-center justify-center">
        ...
        {totalCards > 0 && (
          <div className="space-y-2">
            ...
            <div className="relative h-2 bg-slate-100 rounded-full overflow-hidden">
              <div
                className="absolute inset-y-0 left-0 bg-linear-to-r from-emerald-500 to-teal-500 rounded-full transition-all duration-500 ease-in-out"
