...
const FlashcardManager = ({ documentId }) => {
  ...
  return (
    <>
      <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3xl shadow-lg shadow-slate-200/50 p-8">
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-end gap-3 pt-2">
            ...
            <button
              ...
              disabled={deleting}
              className="px-5 h-11 bg-linear-to-r from-rose-500 to-rose-600 hover:from-rose-600 hover:to-rose-600 text-white font-semibold text-sm rounded-xl transition-all duration-200 shadow-lg shadow-rose-500/25 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:active:scale-100"
            >
              {deleting ? (
